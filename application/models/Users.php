        ...
        if ($account_exists > 0) {
            ...
            if (isset($user_data['fldSkills']) && !empty($user_data['fldSkills'])) {
                ...
                foreach ($user_data['fldSkills'] as $value) {
                    ...
                    $this->db->insert('user_area_of_interest',$user_area_of_interest);
            ...
            if ($result) {
                ...
                $result3 = $this->db->insert('user_login', $data);
...
//modified on 21-10-2020
    ...
    public function get_user_ueser_login_id($userid = null)

    {
     ...
     public function get_user_bankInfo($userid = null)
...

    {
     ...
     public function update_portfolio($objUserData = null, $editId = null, $portfolioimage = null, $userId = null)
