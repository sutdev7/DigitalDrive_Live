        ...
        <div class="col-lg-12 col-md-12 col-xs-12">
          <div class="task_Left">
            ...
            <div class="task_Left_Div task-Full">
              ...
              <!-- Payment form -->
			        <form action="<?php echo base_url('stripe/pay/{taskinfo}{task_id}{/taskinfo}'); ?>" method="POST" id="paymentFrm">
            ...
            <a href="<?php echo base_url('paypal/pay/{taskinfo}{task_id}{/taskinfo}'); ?>" class="btn">
