...
<div class="content-wrapper">
   ...
   <div class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Message All</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
         ...
         <div class="row">
            <div class="col-12">
               <div class="card">
                  ...
                  <!-- /.card-header -->
                  <div class="container">
                     <h3 class=" text-center"><?php //foreach ($messages as $key => $row) {echo $row->username; }
                    
                     $user_detils= $this->db->get_where('user_login',array('user_id' => $username))->row();
                     echo $user_detils->username;
                     ?> Messaging </h3>
                     <div class="messaging">
                        <div class="inbox_msg">
                                      ...
                                      ?>
                                             <div class="chat_list <?php if($row->user_id ==  $this->uri->segment('3')) echo 'active_chat' ?>">
                                                <div class="chat_people">
                                                   ...
                                                   <div class="chat_ib">
                                                      <h5> <a href="<?= base_url() ?>admin/view-messages/<?php echo $row->user_id; ?>" title="View Details"><?= $row->name ?><span class="rounded-circle" style="color:white;background:green;border:9px green solid;border-radius: 25px solid red;"><?php echo !empty(count_message__view($row->user_id))?count_message__view($row->user_id):'0'; ?></span></a></h5>
                                                       <span class="chat_date"> (<?php if ($row->user_type == 3) {
                                                                    echo 'client';
