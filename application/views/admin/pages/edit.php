...
<?php
	...
	if(!empty($info)){ //echo '<pre>'; print_r($info); die; 
		...
		$account_number = isset($info->card_no) ? $info->account_number : '';		
		...
		<div class="row">
			...
			<div class="col-lg-6">
				<div class="card card-info card-outline">
					...
					<div class="card-body">
						<div class="form-group row">
							<label for="card_no_id" class="col-sm-3 col-form-label">Account Number</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" id="card_no_id" placeholder="Card Number" name="card_no" value="<?php echo $bankinfo->account_number?>">
							</div>
						</div>
						<div class="form-group row">
							<label for="exp_id" class="col-sm-3 col-form-label">Account Name</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" id="exp_id" placeholder="" name="exp" value="<?=$bankinfo->account_name?>">
							</div>
							
						</div>
						<div class="form-group row">
							<label for="card_name_id" class="col-sm-3 col-form-label">Bank Name</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" id="card_name_id" placeholder="" name="card_name" value="<?=$bankinfo->bank_name?>">
							</div>
						</div>
						<div class="form-group row">
							<label for="card_name_id" class="col-sm-3 col-form-label">IFSC CODE</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" id="card_name_id" placeholder="" name="card_name" value="<?=$bankinfo->ifsc_code?>">
							</div>
						</div>
					</div>
				</div>
