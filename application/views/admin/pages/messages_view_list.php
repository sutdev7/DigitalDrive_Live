                    ...
                    ?>
                       <div class="chat_list <?php if($row['user_id'] ==  $this->uri->segment('3')) echo 'active_chat' ?>">
                        <div class="chat_people">
                           <div class="chat_img"> 
                                          <a href="<?php echo base_url()."public-profile/".$row['profile_id'] ?>"><img src="<?php echo $user_profile_image; ?>" alt="<?= $row['name'] ?>">
                      ...
                      <?php endif; ?>
                           ...
                           <div class="chat_ib">
                            <h5> <a href="<?= base_url() ?>admin/view-messages/<?php echo $row['user_id']; ?>"><?= $row['name'] ?> <span class="chat_date"> (<?php if ($row['user_type'] == 3) {
                                  echo 'client';
...
span.custom-tooltip {
    ...
    visibility: hidden;
    transition: all .2s;
    box-shadow: 0px 10px 10px rgba(52, 58, 64, 0.10);
}
.messaging .inbox_msg .inbox_people .inbox_chat .chat_list .chat_img a:hover span.custom-tooltip{
	top: 50px;
	opacity: 1;
	visibility: visible;
}
.messaging .inbox_msg .inbox_people .inbox_chat .chat_list .chat_people .chat_ib h5 a:hover span.custom-tooltip{
	top: 25px;
	opacity: 1;
	visibility: visible;
}
...
.messaging .inbox_msg .mesgs .msg_history .chat_msg span.custom-tooltip {
    top: 50%;
    left: 45px;
}
.messaging .inbox_msg .mesgs .msg_history .chat_msg span.custom-tooltip::before {
    transform: rotate(45deg) translate(8px, 12px);
}
.messaging .inbox_msg .mesgs .msg_history .chat_msg .Profile-pic:hover+span.custom-tooltip {
    opacity: 1;
    visibility: visible;
    left: 52px;
}
