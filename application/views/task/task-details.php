...
<main id="main"> 
    ...
    <section id="postDiv">
        ...
        <div class="container">             
            ...
            {task_info}    
                <div class="col-lg-8">
                    <div class="task_Left" style="padding: 0px !important;">
                ...
                <div class="col-lg-4">
                   ...
                   <?php 
                    ...
                    <div class="card text-center" >
                        <div class="card-header"><h3> <?php echo $heading; ?></h3> </div>
                    </div>
                        ...
                        <ul class="RvwLists" style="margin-top: 1.5rem !important;">
                            ...
                            if (isset($top_freelancers) && !empty($top_freelancers)) {

                                foreach ($top_freelancers as $fRow) {
                    ...
                    if(count($proposals) > 0) {
                        ...
                        <a href="<?php echo base_url()?>received-offers/{task_info}{user_task_id}{/task_info}" class="eyeBtn"> <i class="fa fa-eye" aria-hidden="true"></i> Received Offers</a>
