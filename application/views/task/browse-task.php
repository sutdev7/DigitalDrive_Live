							            ...
							            <tbody>
							              ...
							              <tr>
							                ...
							                <td style="padding-left: 0px">
							                  ...
							                  <img class="card-img-top img-circle" src="{user_image}"  style="width:50px;height:50px;border-radius: 73px;margin: 5px 45px 0px 12px;" /><span class="task_name" style=" font-size: 23px;">{task_created_by}
							                </td>
							           

							                <td><p style=" font-size: 18px;margin-top: 16px;">  {task_name}</p></td>

							                <td><p style=" font-size: 18px;margin-top: 16px;"> {doc}</p></td>

							                <td ><div style="margin-top: 16px;">$ {task_total_budget}</div></td>

							                <td><small class="btn btn-danger" style="margin-top: 12px;"> 
