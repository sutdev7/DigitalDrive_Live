                ...
                <div class="anaaDiv">
                  <div  class="chackDiv">
                    <label class="containerDiv">
                      ...
                      <span class="checkmark" style="border: 1px solid #5f5f60;"></span> </label>
                  </div>
...
<script> 
  ...
  $(document).ready(function() {
	...
	$(document).on('click','.chkSelectFreelancer',function(){
	...
	$(document).on('click','#linkMakeOffer',function(){
	...
	$(document).on('click','.directhire',function(){
      event.preventDefault();
      var actionUrl = $(this).data('formaction');
      var formId = $(this).data('formid');      
