                  ...
                  <li>
                    ...
                    <div class="Txthldr">
                      ...
                      <ul class="CanditateDtls">
                        <li><img src="<?php  echo base_url('assets/img/round-img1.png'); ?>" alt=""/>{user_info} {country} {/user_info}</li>
                      </ul>
...
<!--
                  ...
                  <div class="opening-task">
                    ...
                    <div class="caption"> <big> <?php echo $pending_projects; ?>+ </big> <em> Completed Tasks</em> </div>
                  </div>
                  <div class="opening-task">
                    <div class="spansec"> <img src="<?= base_url().'assets/img/round-icon2.png' ?>" alt="img"> </div>
                    <div class="caption"> <big> $<?php echo number_format($yearly_income); ?> </big> <em> Spent on Hire-n-Work </em> </div>
                  </div>
