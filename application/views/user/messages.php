...
<div style="display:none" id="temp_updated_message"></div>
<?php
  ...
  function check_messages_visibility(html_msg)
  {
	...
	$.ajax({
		 ...
		 $(".chatWrapper").mCustomScrollbar({
			...
			for(var i=0;i<d.updated.length;i++)
			{
			  var cls = d.updated_class[i];
			  var content  = d.updated[i];
			  $("#temp_updated_message").html(content);
			  var c = $("#temp_updated_message").find('.submit_wrap').html();
