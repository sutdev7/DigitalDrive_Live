	...
	<div class="row">
	  ...
	  <div class="col-md-2">
		...
		<div class="molivi-sec-box-add"> 
			...
			<a href="<?php echo base_url(); ?>post-task-step-1" class="btn btn-primary"> Post a New Task </a>

			<!-- <a href="<?php echo base_url(); ?>post-microkey-client" class="btn btn-primary" style="display: none"> Post a Microkey </a>  -->
