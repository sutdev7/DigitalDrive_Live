    ...
    <div class="gig-prof">
     <!--  <img src="{user_image}" class="user-img" style="width:60px;height:50px;"> -->
      ...
      <div style="display: inline-flex;">
       <div class="text-center" style="background: #0080008f;flex: 1;width: 81px;border-radius: 5px;"><a href="<?=base_url()?>reviews" title="" class="follow"  style="color: white;">Review</a></div>
