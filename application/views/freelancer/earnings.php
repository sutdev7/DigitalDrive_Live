              ...
              <table class="table">
                ...
                <!-- Display posts list -->
                  ...
                  <tr>
                    ...
                    <a data-toggle="tooltip" onclick="confirmreq('<?php echo base_url(); ?>razorpay/withdrawal_request/<?php echo $row['id'] ;?>')" data-placement="top" title="request for withdraw" href="javascript:void(0);"> <i class="fa fa-money" style="font-size:24px;"></i> </a>&nbsp;&nbsp;&nbsp;

                    <a data-toggle="tooltip" data-placement="top" title="Details" href="<?php echo base_url() ;?>hired-job-details/<?php echo $row['user_task_id'] ;?>"> <i class="fa fa-eye" style="font-size:24px;" aria-hidden="true"></i> </a>
...
function confirmreq(url) {
  ...
  var txt;
  var r = confirm("Do you realy want to widraw the money");
  if (r == true) {
    // txt = "You pressed OK!";
    window.location = url;
  } else {
