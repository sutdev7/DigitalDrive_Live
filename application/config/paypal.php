...
// $config['business'] = 'hirenwork.com_api1.gmail.com'; // 'sb-y43i3p4152005@business.example.com';//'Your_PayPal_Email'; 
$config['business'] = 'sb-y43i3p4152005@business.example.com';//'Your_PayPal_Email';
