...
$route['paymentsave'] = 'User/paymentsave';
$route['paymentupdate'] = 'User/paymentupdate';
...
$route['received-offers/(:any)/(:num)'] = 'Task/view_received_offer/$1/$2';
$route['received-offers/(:any)'] = 'Task/received_offers/$1';
...
$route['download_attachment_proposal/(:any)'] = 'Task/download_attachment_proposal/$1';
...
$route['admin/problem-ticket/(:any)'] = 'Admin/problem_ticket_list/$1';
$route['admin/client-task'] = 'Admin/client_task';
...
$route['admin/view-messages/(:any)'] = 'Admin/view_messages/$1';
$route['admin/view-messages']       = 'Admin/view_messages';
...
$route['update-microkey-client/(:any)'] = 'Freelancer/update_microkey_client_post/$1';
...
$route['microkey-list-client/(:num)'] = 'Freelancer/microkey_list_client/$1';
...
$route['microkey-job-details/(:any)'] = 'Freelancer/microkey_job_details/$l';
$route['save-inappropriate-microkey'] = 'Freelancer/save_inappropriate_microkey';
$route['save-microkey-job'] = 'Freelancer/save_microkey_job';
